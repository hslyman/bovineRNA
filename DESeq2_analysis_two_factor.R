...
library(DESeq2) #equivalent
library(biomaRt) #equivalent
...
project_directory="~/Documents/School/Davis_GGG/milk/RNAseq/differentialExpression/DESeq2/" #equivalent
data_directory=paste(project_directory, "data/", sep = "") #equivalent
output_directory=paste(project_directory, "results/", sep = "") #equivalent

#do not use sample L495. It is unmatched.
...
#set control and treatment (NOT SURE EXACTLY WHAT'S HAPPENING HERE)
